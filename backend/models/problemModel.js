...
const problemSchema = new mongoose.Schema({
  ...
  constraintDescription: {
    type: String,
    required: [true, 'A problem must have a constraint description!'],
    trim: true,
  },
  inputDescription: {
    type: String,
    required: [true, 'A problem must have input description!'],
    trim: true,
  },
  outputDescription: {
    type: String,
    required: [true, 'A problem must have output description!'],
    trim: true,
  },
  openTestCases: [
    {
